...
1. **Executive summary** — one grounded paragraph; name top three capital / obligation risks
2. **Verbatim extracts** — quote exact RFP language with section/page refs and `[chunk-…]` citations
3. **Summary table(s)** — upfront capital, inventory, disposition, lease/buy obligations
4. **Risk and performance implications** — H/M/L with cited basis only
5. **Proposal implications** — financing, transition, or BOE actions supported by documents only
