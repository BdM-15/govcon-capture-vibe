...
1. **Executive summary** — one grounded paragraph; name top three risks by CLIN or clause
2. **Verbatim extracts** — quote exact RFP language with section/page refs and `[chunk-…]` citations
3. **Summary table(s)** — focus-specific; one row per material term, CLIN, or milestone
4. **Risk and performance implications** — H/M/L with cited basis only
5. **Proposal implications** — BOE / narrative actions supported by documents only
