"""Platform hooks for readiness-frame-pains deliverable quality."""
...
_DELIVERABLE = "pains_handoff.json"
_LABEL = "Pains handoff"
...
def validate_skill_run(
    ...
    *,
    ...
    if validate_handoff_run is None:
        return []
    try:
        from src.skills.pains_handoff_repair import repair_pains_handoff
