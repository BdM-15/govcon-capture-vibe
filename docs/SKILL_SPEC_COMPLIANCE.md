...
| `diagnose` (vendored)                      |        ~70 | none                                             | none (`metadata:` block)                      | ✅ Yes (2026-05-15, branch `175-add-mattpocock-skills`)                                                                                        |
| `git-guardrails-claude-code` (vendored)    |        ~55 | scripts                                          | none (`metadata:` block)                      | ✅ Yes (2026-05-15, branch `175-add-mattpocock-skills`)                                                                                        |
| `grill-me` (vendored)                      |        ~10 | evals                                            | none (`metadata:` block)                      | ✅ Yes (2026-05-01, branch `156-developer-skills`)                                                                                             |
| `grill-with-docs` (vendored)               |        ~35 | none                                             | none (`metadata:` block)                      | ✅ Yes (2026-05-15, branch `175-add-mattpocock-skills`)                                                                                        |
| `handoff` (vendored)                       |        ~10 | none                                             | none (`metadata:` block)                      | ✅ Yes (2026-05-15, branch `175-add-mattpocock-skills`; `argument-hint` moved under `metadata:`)                                                |
| `prototype` (vendored)                     |        ~80 | none                                             | none (`metadata:` block)                      | ✅ Yes (2026-05-15, branch `175-add-mattpocock-skills`)                                                                                        |
| `setup-matt-pocock-skills` (vendored)      |       ~115 | none                                             | none (`metadata:` block)                      | ✅ Yes (2026-05-15, branch `175-add-mattpocock-skills`; `disable-model-invocation` moved under `metadata:`)                                     |
| `setup-pre-commit` (vendored)              |        ~45 | none                                             | none (`metadata:` block)                      | ✅ Yes (2026-05-15, branch `175-add-mattpocock-skills`)                                                                                        |
...
| `triage` (vendored)                        |        ~75 | none                                             | none (`metadata:` block)                      | ✅ Yes (2026-05-15, branch `175-add-mattpocock-skills`)                                                                                        |
| `write-a-skill` (vendored)                 |        ~70 | none                                             | none (`metadata:` block)                      | ✅ Yes (2026-05-15, branch `175-add-mattpocock-skills`)                                                                                        |
| `zoom-out` (vendored)                      |         ~5 | none                                             | none (`metadata:` block)                      | ✅ Yes (2026-05-15, branch `175-add-mattpocock-skills`; `disable-model-invocation` moved under `metadata:`)                                     |
...
produce a Studio-visible Word brief. Source `report.md/json` remains on disk for
reasoning/editing workflows but is filtered out of Studio. Workbook emission is
profile-driven and data-driven: known skill envelopes are tried first, then any
non-source JSON artifacts; the XLSX renderer publishes only files with real
array-of-object data, including nested envelope arrays such as obligation
rollups. This prevents faux workbook products while still making data-heavy
skills populate Studio automatically.
