"""Pure-ish helpers for skill run persistence and listing."""
...
from src.skills.run_metadata import parse_run_envelope, read_run_metadata, resolve_artifact_mime
...
def list_runs_under_base(
    ...
    *,
    ...
    if not base.is_dir():
        return []
    targets = [base / skill_name] if skill_name else [path for path in base.iterdir() if path.is_dir()]
