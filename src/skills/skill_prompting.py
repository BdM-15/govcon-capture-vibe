...
def compose_skill_prompt(
    ...
    return (
        ...
        "  * `retrieval_metadata` — how this slice was selected (researcher-grade\n"
        "    `aquery_data` hybrid retrieval vs. bulk fallback); use it to gauge coverage.\n\n"
        ...
        "The briefing book was assembled by researcher-grade `aquery_data` hybrid "
        "retrieval over the user request + skill description. Treat it as the *complete* "
